...
API_ID = int(environ['API_ID', '27717789'])
API_HASH = environ['API_HASH', 'f862cece3f82192f6db588e6ce542465']
BOT_TOKEN = environ['BOT_TOKEN', '6308656347:AAFmlQ-Grcc21mmtNDLXAIIaVcYB1fd1QXg']
...
auth_channel = environ.get('AUTH_CHANNEL', '1806929531')
auth_grp = environ.get('AUTH_GROUP', '1712006959')
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [Ask more](https://t.me/noidiotsneeded00)</b>⚡\n\n🎦 <b>File Name: </b> ➥  <i>{file_caption}</i>\n⚙️ <b>Size: </b><i>{file_size}</i>\n\n                ❤️<b>WE LOVE YOU</b>❤️\n🔥  ↭ <b>Join Now [Ask more](https://t.me/browearemen)</b> ↭  🔥")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '1933343262')).split()]
...
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', '1806929531'))
...
LZURL_PRIME_USERS = [int(lazyurlers) if id_pattern.search(lazyurlers) else lazyurlers for lazyurlers in environ.get('LZURL_PRIME_USERS', '6575574792').split()]
